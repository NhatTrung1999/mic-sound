...
function DeleteAlert({handleDelete, delRef}) {
    ...
    return (
        <div  id="deleteAlert" className={`flex alert profile-del ${handleDelete === offDetele ? 'show' : ''}`}>
            ...
            <div className="thx-btn" id="deleteConfirm" onClick={AceptDelete}>delete</div>
        </div>
    )
}
